...
@Component({
  selector: 'app-thong-ke-ton-kho1',
  templateUrl: './thong-ke-ton-kho1.component.html',
  styleUrls: ['./thong-ke-ton-kho1.component.css']
})
export class ThongKeTonKho1Component implements OnInit {
  ...
  loadData() {
    ...
    this.thongkeService.getThongKeTonKho1(param).subscribe(result => {
